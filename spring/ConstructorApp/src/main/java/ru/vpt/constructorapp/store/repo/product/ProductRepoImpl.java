    ...
    public List<ProductEntity> findByFilter(FilterDto filter) {
        return new JPAQuery<ProductEntity>(entityManager)
                ...
                .where(QPredicates.builder()
                        ...
                        .add(filter.getRpm(), productEntity.rpm::eq)
                        ...
                        .add(filter.getPosTerminalBox(), productEntity.motor.posTerminalBox::eq)
                        ...
                        .add(filter.getDiamInput() == null ? null : filter.getDiamInput() - filter.getDiamInputAllowance(),productEntity.reducer.diameterInputShaft::goe)
                        .add(filter.getDiamInput() == null ? null : filter.getDiamInput() + filter.getDiamInputAllowance(),productEntity.reducer.diameterInputShaft::loe)
